...
<div class="topbar">  
    ...
    <div class="brand">
        <a href="{{ route('home')}}" class="logo">
            <span>                
                <img src="{{ URL::asset('assets/images/logo-sm.png')}}" alt="logo-small" class="logo-lg">
            </span>
            <span>                
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('home') }}" id="navbarDashboards" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                            <span><i class="ti ti-dashboard menu-icon font-18">  EA-Modules</i></span>
                        </a>
                        <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDashboards"> 
                            <li>
                                <a class="dropdown-item text-uppercase" href="{{ route('crm.index') }}">crm</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item sub-menu-item text-uppercase">shipping</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item text-uppercase" href="{{ route('sales.index') }}">sales</a>
                            </li><!--end /li-->                            
                            <li>
                                <a class="dropdown-item text-uppercase" href="projects-index.html">hr</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item text-uppercase" href="ecommerce-index.html">it</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item text-uppercase" href="helpdesk-index.html">receiving</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item text-uppercase" href="hospital-index.html">logistics</a>
                            </li><!--end /li-->
                        </ul>
                    </li><!--end nav-item-->

                    <li class="nav-item dropdown hideProp">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarApps" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span><i class="ti ti-apps menu-icon font-18">  Apps</i></span>
                        </a>
                        <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarApps"> 
                            ...
                            <li>
                                <a href="apps-contact-list.html" class="dropdown-item">
                                    Contact List
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="apps-invoice.html" class="dropdown-item">
                                    Invoice
                                </a>
                            </li>                    
                        </ul><!--end submenu-->
                    ...
                    <li class="nav-item dropdown hideProp">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarUI_Kit" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span><i class="ti ti-planet menu-icon font-18">  UI Kit</i></span>
                        </a>
                    ...
                    <li class="nav-item dropdown hideProp">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarPages" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span><i class="ti ti-file-diff menu-icon font-18">  Pages</i></span>
                        </a>
                        <ul class="dropdown-menu  animate slideIn" aria-labelledby="navbarPages">
                            ...
                            <li>
                                <a class="dropdown-item" href="pages-tour.html">Tour</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="pages-timeline.html">Timeline</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="pages-treeview.html">Treeview</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="horizontal-starter.html">Starter Page</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="pages-pricing.html">Pricing</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="pages-blogs.html">Blogs</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="pages-faq.html">FAQs</a>
                            </li><!--end /li-->
                            <li>
                    ...
                    <li class="nav-item dropdown hideProp">
                        <a class="nav-link dropdown-toggle" href="#" id="navbar_auth" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span><i class="ti ti-shield-lock menu-icon font-18">  Authentication</i></span>
                        </a>
                        <ul class="dropdown-menu  animate slideIn" aria-labelledby="navbar_auth">
                            ...
                            <li>
                                <a class="dropdown-item" href="auth-login-alt.html">Log in alt</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-register.html">Register</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-register-alt.html">Register-alt</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-recover-pw.html">Re-Password</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-recover-pw-alt.html">Re-Password-alt</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-lock-screen.html">Lock Screen</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-lock-screen-alt.html">Lock Screen-alt</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-404.html">Error 404</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-404-alt.html">Error 404-alt</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-500.html">Error 500</a>
                            </li><!--end /li-->
                            <li>
                                <a class="dropdown-item" href="auth-500-alt.html">Error 500-alt</a>
                            </li><!--end /li-->
                        </ul><!--end submenu-->
                    </li><!--end nav-item-->                    
