            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <ul>
                        <li class="menu-item">
                            <!-- Mobile menu toggle-->
                            <a class="navbar-toggle nav-link" id="mobileToggle1"  onclick="toggleMenu()" onclick="toggleMenu()">
                                <div class="lines">
                                    <span></span>
                                    <span></span>
                                    <span></span>
                ...
                <ul class="navigation-menu">
                    <li class="nav-item hideProp">
                        <a class="nav-link" href="{{ route('home') }}" aria-haspopup="true" aria-expanded="false" data-display="static">
                            <span><i class="ti ti-home menu-icon font-18">  EA-CRM</i></span>
                        </a>
                    </li>
                    ...
                    @can('isAdmin')
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ route('home') }}" id="navbarDashboards1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                            <span><i class="ti ti-dashboard menu-icon font-18">  EA-Modules</i></span>
                        </a>
                        <ul class="dropdown-menu animate slideIn" aria-labelledby="navbarDashboards1"> 
                            <li>
